...
- **理解原理**：建议根据 [数据流函数层级图](./TECHNICAL_DETAILS.md#%E6%95%B0%E6%8D%AE%E6%B5%81%E5%87%BD%E6%95%B0%E5%B1%82%E7%BA%A7%E5%9B%BE) 查阅对应章节进行阅读。每一章开头都有"阶段概要"，用 2-3 句话说明该阶段的输入、操作和输出，帮助建立整体认知后再深入细节。
...
示例（[train_data.json](../examples/train_data.json)）：
...
6. `CustomSeq2SeqTrainer.compute_loss` 在 `Trainer.compute_loss` 的基础上进行重写
